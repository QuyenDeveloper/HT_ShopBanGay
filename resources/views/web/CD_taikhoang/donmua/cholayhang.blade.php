        ...
        @foreach($layhangs as $layhang)
            <div class="dh">
                ...
                <div style="background: #f6f4ee; border-radius: 5px;">
                    ...
                    <div class="nut">
                        <a class="cho"><button>Chờ </button></a>
                        <a href="/trangchu/tai_khoan/ND_donhang/{{$layhang->idDMua}}"><button>Xem chi tiết đơn </button></a>
                        <a href="#"><button>Liên hệ </button></a>
                        <a href="/trangchu/tai_khoan/huy_don2/{{$layhang->idDMua}}"><button>Hủy đơn hàng</button></a>
                    </div>
