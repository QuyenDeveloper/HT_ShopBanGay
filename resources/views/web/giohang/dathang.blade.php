        ...
        <div class="container header-middle-cont">
            <div class="toplogo">
                <a href="/trangchu" class="row" style="width: 500px;">
                    <img src="/web/img/logo.png" class="col-sm-6" style="border-right:2px solid #178dc7; padding-right: 15px; " alt="AllStore - MultiConcept eCommerce Template"> <span class="col-sm-6" style="color: #178dc7  ; font-size: 28px; margin-top: 5px;">Thanh toán</span>
                </a>
            </div>
            <div class="shop-menu">
                <ul>
...
{{--                                        <input type="hidden" id="idSP_GH-{{$sanpham->id}}" name="idSP_GH-{{$sanpham->id}}" value="{{$sanpham->id}}">--}}
            ...
            <div class="row borderall m-0">
                ...
                <div class="col-md-4 pd">
                    ...
                    <input class="loinhanInput" type="text" name="loinhan" id="loinhan" placeholder="Lưu ý cho Người bán ...">
                </div>
...
{{--                        <span class="col-md-4 prod-head" id="phiVCFinal"  style="text-align: right;">aaaa4(tien)</span>--}}
                ...
                <div class="row bordertop pd-120 m-0">
                    <span>Nhấn "Đặt hàng" đồng nghĩa với việc bạn đồng ý tuân theo <a class="thaydoi" href="#">Điều khoản AllStore</a></span>
                    <input type="submit" class="col-md-3 fl-r btn" id="datHangBtn" value="Đặt hàng">
                </div>
            </div>
            @csrf
        </form>
