...
//             // alert(results);
//             if (results.error == false){
//                 $('#image_show11') . html('<a href="'+ results.url +'" target="_blank">' +
//                     '<img src="'+ results.url +'" width="100px" /></a>');
//                 $('#color1').val(results.url);
//             }else{
//                 alert('upload file lỗi!!');
//             }
//         }
...
//             // alert(results);
//             if (results.error == false){
//                 $('#image_show12') . html('<a href="'+ results.url +'" target="_blank">' +
//                     '<img src="'+ results.url +'" width="100px" /></a>');
//                 $('#color2').val(results.url);
//             }else{
//                 alert('upload file lỗi!!');
//             }
//         }
...
//             // alert(results);
//             if (results.error == false){
//                 $('#image_show13') . html('<a href="'+ results.url +'" target="_blank">' +
//                     '<img src="'+ results.url +'" width="100px" /></a>');
//                 $('#color3').val(results.url);
//             }else{
//                 alert('upload file lỗi!!');
//             }
//         }
...
//             // alert(results);
//             if (results.error == false){
//                 $('#image_show14') . html('<a href="'+ results.url +'" target="_blank">' +
//                     '<img src="'+ results.url +'" width="100px" /></a>');
//                 $('#color4').val(results.url);
//             }else{
//                 alert('upload file lỗi!!');
//             }
//         }
...
//             // alert(results);
//             if (results.error == false){
//                 $('#image_show15') . html('<a href="'+ results.url +'" target="_blank">' +
//                     '<img src="'+ results.url +'" width="100px" /></a>');
//                 $('#color5').val(results.url);
//             }else{
//                 alert('upload file lỗi!!');
//             }
//         }
...
//             // alert(results);
//             if (results.error == false){
//                 $('#image_show16') . html('<a href="'+ results.url +'" target="_blank">' +
//                     '<img src="'+ results.url +'" width="100px" /></a>');
//                 $('#color6').val(results.url);
//             }else{
//                 alert('upload file lỗi!!');
//             }
//         }
